...
public interface IPdfResourceBuilder
{
    ...
    /// </summary>
    /// <typeparam name="TElement">The type of the element the style targets (e.g., IPdfParagraph).</typeparam>
    ...
    IPdfResourceBuilder Style<TElement>(string key, Action<TElement> setup) where TElement : class;
    ...
    /// <returns>The <see cref="IPdfResourceBuilder"/> for chaining.</returns>
    IPdfResourceBuilder Style<TElement>(string key, string basedOn, Action<TElement> setup) where TElement : class;
}

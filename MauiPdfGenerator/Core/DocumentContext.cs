...
internal class DocumentContext : IDisposable
{
    ...
    private readonly List<PageBuildResult> _pendingPages = [];
    ...
    internal DocumentContext(DocumentOptions options, PdfWriter writer)
    {
        ...
        {
            [PdfConstants.Names.Type] = new PdfName(PdfConstants.Names.Pages),
            [PdfConstants.Names.Kids] = _pageKidsArray,
            [PdfConstants.Names.Count] = new PdfInteger(0) // Will be updated later
        };
